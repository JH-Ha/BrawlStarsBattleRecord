...
const PentaMode = ({ battleTime,
    ...
    type,
    mode,
    groupRecords }: PentaModeProps) => {

    const { t } = useTranslation();

    return (
        <div className={styles.center}>
            <div className={`${styles.pentaContainer} ${styles[result]}`}>
                ...
                <div className={`${styles.playerInfo} ${styles.info} ${styles[result]}`}>
                    <div className={`${styles.pentaPlayerContainer}`}>
