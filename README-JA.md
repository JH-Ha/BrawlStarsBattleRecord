...
フロントエンドは Next.js で構築されており、バックエンドは Spring フレームワークを使用して開発されています。
...
このプロジェクトには、Next.js、Spring Boot、JPA が使用されています。バックエンドは Java 25 LTS で動作しています。
...
- v2.6.0 (2026.03.22)
  - Java 17 から 25 LTS へアップグレード
  - GitHub Codespace 用 devcontainer 設定を追加
  - JavaScript を TypeScript に変換
  - レガシー Express.js サーバーファイルを削除
- v2.5.1 (2024.10)
  - 新しいブロウラー画像を追加
  - ブロウラー画像フォーマットを PNG から WebP に変更
- v2.5.0 (2024.10)
  - 新しいブロウラーと名前の翻訳を追加
- v2.4.9 (2024.09.21)
  - イメージサイズを削減するためにイメージフォーマットを PNG から WebP に変更
- v2.4.8 (2024.08.02)
  - ブロスタペインターモードを支援
- v2.4.7 (2024.07.24)
  - 5v5 モードを支援
